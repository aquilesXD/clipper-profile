  ...
  return (
    <div className="fixed left-0 top-0 z-30 h-full w-16 bg-[#0c0c0c] border-r border-[#1c1c1c] flex flex-col items-center">
      ...
      <div className="flex flex-col items-center justify-center h-full -mt-12 space-y-4">
        <Link
          to="/"
          className={`flex h-10 w-10 items-center justify-center rounded-md bg-[#161616] ${path === '/' ? 'text-white' : 'text-gray-500'}`}
          aria-label="Home"
        >
        ...
        <Link
          to="#"
          className="flex h-10 w-10 items-center justify-center rounded-md bg-[#161616] text-gray-500"
          aria-label="Messages"
        >
        ...
        <Link
          to="/profile"
          className={`flex h-10 w-10 items-center justify-center rounded-md bg-[#161616] ${path.includes('/profile') ? 'text-white' : 'text-gray-500'}`}
          aria-label="Profile"
        >
