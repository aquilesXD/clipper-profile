            ...
            <div className="col-span-1 md:col-span-4">
              <div className="relative">
                <input
                  ...
                  className="w-full bg-[#121212] border border-[#2a2a2a] rounded-md py-2 px-3 text-white"
                  value={searchQuery}
                  onChange={(e) => setSearchQuery(e.target.value)}
                />
                <button className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-[#1c1c1c] hover:bg-[#252525] text-white p-1 rounded-md">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
            <div>
              <div className="inline-flex rounded-md shadow-sm">
                <button className="bg-[#1c1c1c] hover:bg-orange-600 text-white px-4 py-2 rounded-l-md">Todos</button>
                <button className="bg-[#1c1c1c] hover:bg-orange-600 text-white px-4 py-2 border-x border-[#2a2a2a]">
                  Reporte
                </button>
                <button className="bg-[#1c1c1c] hover:bg-orange-600 text-white px-4 py-2 rounded-r-md">UGC</button>
              </div>
            </div>
